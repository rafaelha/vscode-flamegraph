...
### Fixed
- Fixed issue with Python path resolution by enforcing absolute paths. This addresses a problem on Linux where sudo's secure path doesn't include the py-spy binary location.
